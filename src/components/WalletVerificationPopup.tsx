        ...
        {phase === 'writeup' && (
          <div className="flex flex-col items-center gap-5 py-6 px-2 text-center">
            ...
            <button
              ...
              className="mt-3 px-6 py-2.5 rounded-lg bg-gradient-to-r from-primary to-secondary text-white font-semibold text-sm shadow-[0_0_15px_rgba(255,100,0,0.5)] hover:scale-105 transition-transform duration-200"
            >
              Verify Wallet
            </button>
          </div>
